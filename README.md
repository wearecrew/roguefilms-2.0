...
**Current phase:** Phase 0 closing out, Phase 1 ready to start.

**In flight:**
- Project plan and README at v1.1 with design walkthrough findings incorporated.
- Webflow MCP audit complete (CMS schemas pulled, page list mapped, scripts confirmed to live in Designer not Apps).
- Design walkthrough complete (six key Figma frames reviewed): Homepage, Talent, Music Video, Film & TV, Director, Lightbox/Work detail.

**Done:**
- Site duplicated as Roguefilms 2.0.
- v1 audit: pages, collections, video CMS fields, custom script location.
- Design walkthrough and architectural assumptions corrected (notably Talent page = text-led, not grid).
- Vimeo plan confirmed (Pro, HLS available).

**Next up:**
- Set up Figma MCP for inline chat use.
- Phase 1 foundation: variables, classes, Finsweet attributes baseline.
- Phase 2 Talent page can begin in parallel with Phase 1 streams.
